...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
		<!-- include가 무엇인가... 여기서 실행한 결과를 불러온 곳에다가 갖다붙이는 것  -->
                    ...
                    <div class="col-lg-8">
                        ...
                        <c:forEach var="board" items="${boards}" varStatus="status">
                            ...
                            <nav class="blog-pagination justify-content-center d-flex">
		                        <ul class="pagination">
		                            <li class="page-item">
		                                <a href="/blog/board?cmd=list&page=${param.page-1}" class="page-link" aria-label="Previous">
		                                ...
		                                <a href="/blog/board?cmd=list&page=${param.page+1}" class="page-link" aria-label="Next">
		                                    <span aria-hidden="true">
                        ...
                        <div class="blog_right_sidebar">
                            ...
                            <aside class="single_sidebar_widget popular_post_widget">
                                ...
                                <div class="media post_item">
                                    <img style="width:100px; height:60px" src="${board.previewImg}" alt="post">
